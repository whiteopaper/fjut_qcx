...
import 'package:fjut_qcx/order/page/order_list_page.dart';
...
class _OrderPageState extends State<OrderPage> with AutomaticKeepAliveClientMixin<OrderPage>, SingleTickerProviderStateMixin {
  ...
  _preCacheImage() {
    precacheImage(ImageUtils.getAssetImage('order/icon_keynote'), context);
    precacheImage(ImageUtils.getAssetImage('order/icon_jobFair'), context);
    precacheImage(ImageUtils.getAssetImage('order/icon_regulations'), context);
  }
...
var img = [
  ['order/icon_keynote_fill', 'order/icon_keynote'],
  ['order/icon_jobFair_fill', 'order/icon_jobFair'],
  ['order/icon_regulations_fill', 'order/icon_regulations'],
];
